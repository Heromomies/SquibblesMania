	...
	void PlayerTurnActionStateSelectBlock()
	{
		    ...
		    GameManager.Instance.currentPlayerTurn.isPlayerInActionCardState)
		{
			    ...
			    GameManager.Instance.currentPlayerTurn.playerActionPoint > 0)
			{
				...
				{
					case 1: uiInteraction[0].uiInteractionParentObject.SetActive(false); break;
					case 2: uiInteraction[0].uiInteractionParentObject.SetActive(false); break;
					case 3: uiInteraction[1].uiInteractionParentObject.SetActive(false); break;
					case 4: uiInteraction[1].uiInteractionParentObject.SetActive(false); break;
				}
